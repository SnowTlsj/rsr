    ...
    <main class="main-content">
      <div class="left-panel">
        ...
        <div class="data-grid">
          ...
          <div class="data-row"><label>匀播指数：</label><div class="value-box">{{ uniformityIndex }}</div><span class="unit">%</span></div>
        </div>
      </div>
...
const uniformityIndex = computed(() => {
  ...
  // 计算匀播指数
  const index = avg > 0 ? (1 - stdDev / avg) * 100 : 0;
...
<style scoped>
.monitor-container { font-family: "Microsoft YaHei", sans-serif; max-width: 1400px; margin: 0 auto; background-color: #fff; }
...
.main-content { display: flex; flex-direction: row; border: 2px dashed #333; margin: 20px; min-height: 650px; }
